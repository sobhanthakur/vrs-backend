...
class TabsController extends FOSRestController
{
     ...
     * Images tab details
     * @SWG\Tag(name="Tabs")
     * @Get("/tabs/images", name="vrs_pwa_tabs_images")
     * @SWG\Parameter(
     *     name="data",
     *     in="query",
     *     required=true,
     ...
     * @SWG\Response(
     *     response=200,
     *     description="Show Images tab details",
     * )
     * @return array
     * @param Request $request
     */
    ...
    /**
     * Assignments tab details
     * @SWG\Tag(name="Tabs")
     * @Get("/tabs/assignments", name="vrs_pwa_tabs_assignments")
     * @SWG\Parameter(
     *     name="data",
     *     in="query",
     *     required=true,
     ...
     * @SWG\Response(
     *     response=200,
     *     description="Show Assignments tab details",
     * )
     * @return array
     * @param Request $request
     */
