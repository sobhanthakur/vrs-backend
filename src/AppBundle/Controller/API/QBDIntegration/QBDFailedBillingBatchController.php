...
use AppBundle\QBDHelpers\Applications\QBDFailedBillingBatchService;

class QBDFailedBillingBatchController extends Controller
{
    /**
     * @Route("qbdfailedsalesorders")
    ...
    public function FailedQBDBillingBatchRequest(Request $request)
    {
        ...
        try {
            ...
            $qbdResource = new QBDFailedBillingBatchService([
                'login' => $login,
                'password' => $password,
                'iterator' => null,
