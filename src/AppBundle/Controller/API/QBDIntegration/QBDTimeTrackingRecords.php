...
use AppBundle\QBDHelpers\Applications\QBDTimeTrackingBatchService;
...
/**
 * Class QBDTimeTrackingRecords
 * @package AppBundle\Controller\API\QBDIntegration
 */
class QBDTimeTrackingRecords extends Controller
{
    /**
     * @Route("qbdtimetrackingrecords")
    ...
    public function QBDTimeTrackingBatchRequest(Request $request)
    {
        ...
        try {
            ...
            $qbdResource = new QBDTimeTrackingBatchService([
                'login' => $login,
                'password' => $password,
                'iterator' => null,
