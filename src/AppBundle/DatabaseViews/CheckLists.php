...
{
    const vServicesToPropertiesChecklistItems = 'SELECT  dbo.Checklists.ChecklistID,dbo.Checklists.ChecklistName, dbo.ChecklistsToChecklistItems.ChecklistItemID, dbo.ChecklistItems.ChecklistTypeID, dbo.ChecklistItems.ChecklistItem, dbo.ChecklistItems.InternalName, dbo.ChecklistItems.Description, 
                         ...
                         dbo.ChecklistItems.ChecklistItemID AS Expr1, dbo.Checklists.ParentChecklistID, dbo.ServicesToProperties.ChecklistID AS Expr2, dbo.ServicesToProperties.ServiceID, 
...
FROM            dbo.ChecklistItems RIGHT OUTER JOIN
    ...
    const vServicesChecklistItems = 'SELECT   dbo.Checklists.ChecklistID,   dbo.Checklists.ChecklistName, dbo.ChecklistsToChecklistItems.ChecklistItemID, dbo.ChecklistItems.ChecklistTypeID, dbo.ChecklistItems.ChecklistItem, dbo.ChecklistItems.InternalName, dbo.ChecklistItems.Description, 
                         dbo.ChecklistItems.Image, dbo.ChecklistItems.Options, dbo.ChecklistItems.ColumnCount, dbo.ChecklistItems.Required, dbo.ChecklistItems.ShowOnOwnerReport, dbo.ChecklistItems.ShowImageOnOwnerReport, 
                         dbo.ChecklistItems.ChecklistItemID AS Expr1, dbo.Checklists.ParentChecklistID, dbo.Services.ServiceID, dbo.ChecklistsToChecklistItems.SortOrder, dbo.ChecklistItems.ShowDescription
