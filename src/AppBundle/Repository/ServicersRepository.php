...
class ServicersRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function ServicerDashboardRestrictions($servicerID,$restrictions=null)
    {
        $result = $this
            ...
            ->addSelect('c.golivedate AS GoLiveDate');
        ...
        $result->where('s.servicerid= :ServicerID')
            ...
            ->leftJoin('AppBundle:Locale', 'cl', Expr\Join::WITH, 'c.localeid=cl.localeid')
            ->setParameter('ServicerID', $servicerID)
            ->setMaxResults(1);
