...
class ServicersRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function GetRestrictions($staffID)
    {
        $servicersRestrictions = $this
            ...
            ->select('s.allowadminaccess, s.allowmanage, s.allowreports, s.allowsetupaccess, s.allowaccountaccess, s.allowissuesaccess, s.allowquickreports, s.allowtracking, s.allowscheduleaccess, s.allowmastercalendar')
