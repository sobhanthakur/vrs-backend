...
class TasksRepository extends EntityRepository
{
    ...
    public function FetchTasksForDashboard($servicerID, $servicers,$taskID=null,$pagination=[])
    {
        ...
        if (!$taskID) {
            ...
            $result->addSelect('npb2.checkin AS NextCheckIn')
