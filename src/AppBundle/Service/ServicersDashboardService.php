...
//            for ($i=0; $i<1; $i++) {
                ...
                $servicers[0]['ShowPiecePayAmountsOnEmployeeDashboards'] ? $piecePay = ((int)$tasks[$i]['PayType'] === 2 ? $tasks[$i]['PiecePay'] * $servicers[0]['PayRate'] : $tasks[$i]['PiecePay']) : $piecePay = null;
